...
public class VolquetaInspActivity extends AppCompatActivity  implements View.OnClickListener{
    private ListView listView;
    private ImageView imImaVehic;
    private TextView fecha_h;
    private Button btContiInspec, btRegresaInsp;
    boolean[] isRojosBooleans = new boolean[]{false,true,true,false ,true ,true ,true ,true ,false ,false ,false,false ,false,false,false,
                                            true,true,false,true ,true ,true ,true ,false ,false ,true ,true,false ,false,true,true,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volqueta_insp);

        dataArray = getResources().getStringArray(R.array.inspec_volqueta);
