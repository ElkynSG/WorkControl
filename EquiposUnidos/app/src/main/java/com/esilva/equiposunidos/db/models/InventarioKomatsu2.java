...
public class InventarioKomatsu2 {
    private int id;
    ...
    private int fRefregerante;

    public InventarioKomatsu2(){
        id=1;
        fAceiteMotor=0;
    ...
    public int getfRefregerante() {
        return fRefregerante;
    }

    public void setfRefregerante(int fRefregerante) {
        this.fRefregerante = fRefregerante;
    }
}
